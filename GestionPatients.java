...
public class GestionPatients {
    ...
    public void ajouter(Scanner scanner) {
        ...
        FichePatient patient = new FichePatient(nom, prenom, adresse, numeroTelephone, dateNaissance, sexe);
    ...
    public void modifier(Scanner scanner) {
        ...
        if (patient != null) {
            ...
            patient.setAdresse(scanner.nextLine().trim());
            System.out.print("Nouveau téléphone : ");
            patient.setNumeroTelephone(scanner.nextLine().trim());
            System.out.print("Nouvelle date de naissance (YYYY-MM-DD) : ");
            patient.setDateNaissance(scanner.nextLine().trim());
