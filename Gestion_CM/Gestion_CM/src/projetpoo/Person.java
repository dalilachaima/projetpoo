...
public class Person {
    ...
    public Person(String nom, String prenom, LocalDate date_de_naissance, String lieu_de_naissance,
    ...
    public void setNumeroTelephone(int numeroTelephone) {
        if (numeroTelephone > 0) { this.numeroTelephone = numeroTelephone; }
        else { throw new IllegalArgumentException("Le numéro de téléphone doit être un nombre positif."); }
    }
