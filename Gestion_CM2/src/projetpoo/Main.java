...
public class Main {
    ...
    private static Medecin lireMedecin(Scanner scanner) {
        ...
        return new Medecin(nomMedecin, dateNaissanceMedecin, lieuNaissanceMedecin, sexeMedecin, adresseMedecin, telephoneMedecin, groupageMedecin, specialiteMedecin, hopitalMedecin, numeroLicenseMedecin);
    }
