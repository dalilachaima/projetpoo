...
public class RendezVous {
    ...
    public void afficherRendezVous() {
        System.out.println("Rendez-vous de " + patient.getNom());
    ...
    public void modifier(LocalDate nouvelleDate, LocalTime nouvelleHeure) {
        if (!nouvelleDate.isBefore(LocalDate.now()) || (nouvelleDate.equals(LocalDate.now()) && nouvelleHeure.isAfter(LocalTime.now()))) {
            ...
            System.out.println("Rendez-vous modifié pour " + patient.getNom() + " " + " le " + date + " à " + heure);
        } else {
    ...
    public void annuler() {
        System.out.println("Rendez-vous annulé pour " + patient.getNom() );
    }

    public boolean planifier() {
        if (medecinDisponible) {
            System.out.println("Rendez-vous planifié pour " + patient.getNom() + " "  + " le " + date + " à " + heure);
            return true;
        } else {
